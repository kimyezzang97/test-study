...
import static com.test_study.test_study.spring.domain.product.ProductSellingStatus.HOLD;
import static com.test_study.test_study.spring.domain.product.ProductSellingStatus.SELLING;
import static org.junit.jupiter.api.Assertions.*;

@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // 기존 DB 설정 유지
//@SpringBootTest
@ActiveProfiles("test")
@DataJpaTest
